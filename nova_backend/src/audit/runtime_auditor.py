...
def _build_discrepancies(
    ...
    registry_set = set(registry_enabled_ids)

    if runtime_doc_set != registry_set:
        discrepancies.append(
            Discrepancy(
                ...
                details={
                    "registry_enabled_ids": sorted(registry_set),
                    "doc_enabled_ids": sorted(runtime_doc_set),
                    "missing_in_doc": sorted(registry_set - runtime_doc_set),
                    "extra_in_doc": sorted(runtime_doc_set - registry_set),
                },
            )
        )
...
def run_runtime_truth_audit() -> dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "registry_enabled_ids": registry_enabled_ids,
            "runtime_doc_enabled_ids": runtime_doc_enabled_ids,
            "mediator_mapped_capability_ids": mediator_map["mapped_capability_ids"],
        },
        "inputs": {
