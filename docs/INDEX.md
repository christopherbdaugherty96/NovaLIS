...
- [Nova Conversation Coherence Layer plan](future/NOVA_CONVERSATION_COHERENCE_LAYER_PLAN.md) - safe usability/context plan for improving intent handling, task-state awareness, paused-work awareness, response templates, and clarity without widening action authority.
