...
**Authoritative sprint detail:** [4-15-26 NEW ROADMAP/Now.md](../../4-15-26%20NEW%20ROADMAP/Now.md)

---

## Next Tasks (ordered by ROI)

- [ ] **Cap 64 P5 live signoff + lock** — run [live checklist](../capability_verification/live_checklists/cap_64_send_email_draft.md), then `certify_capability.py live-signoff 64` + `lock 64`
- [ ] **Dashboard trust card** — pull from `GET /api/trust/receipts`, render last 5 actions inline; backend is live
- [ ] **Windows installer VM validation** — run clean install, capture `C:\Program Files\Nova\bootstrap.log`, fix root cause
...
- [ ] **Cap 65 P5 live signoff** — requires `NOVA_SHOPIFY_SHOP_DOMAIN` + `NOVA_SHOPIFY_ACCESS_TOKEN`; run [live checklist](../capability_verification/live_checklists/cap_65_shopify_intelligence_report.md)
