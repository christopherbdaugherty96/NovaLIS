...
| Phase 3 | 🟡 \*\*Core Complete, Acceptance-Gated\*\* | Memory governance + STT transport implemented; verification required |
...
\- \*\*NOVA v2.0.4 — Synthesized Canonical Truth\*\*

\- \*\*REPO\_MAP.md\*\* — Deterministic repository navigation
